...
<body id="page-top">
    ...
    while($data_member=mysqli_fetch_array($qry_get_member)){
...
echo '<option value="'.$data_member['id'].'" '.$selek.'></option>';   
	...
	<a href="tampil_member.php"> <input type="submit" name="simpan" value="Ubah Member" class="btn btn-success" style="margin-left: 10px;"></a>
