    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                while ($data_user = mysqli_fetch_array($qry_get_user)) {
                ...
                ?>
                    ...
                    <form action="proses_ubah_petugas.php" method="post">
                        ...
                        <select name="level" name="level" value="<?= $data_user['level'] ?>" class="form-control">
                            <option value="admin">admin</option>
                            <option value="kasir">kasir</option>
                            <option value="owner">owner</option>
                            <br><a href="tampil_petugas.php"> <input type="submit" name="simpan" value="Ubah petugas" class="btn btn-success" style="margin-left: 10px;"></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="logout.phpl">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
