                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="tampil_member.php">Member</a>
                            <a class="collapse-item" href="tampil_petugas.php">Petugas</a>
                            <a class="collapse-item" href="tampil_paket.php">Jenis Paket</a>
                        <a class="collapse-item" href="tampil_transaksi.php">Transaksi</a>
                    ...
                    <body>
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                include "../koneksi.php";
                                $qry_transaksi = mysqli_query($conn, "select * from transaksi order by id_transaksi asc");
                                $qry_member = mysqli_query($conn, "select * from member order by id desc");
                                $data_member = mysqli_fetch_array($qry_member);
                                $qry_paket = mysqli_query($conn, "select * from paket order by id_paket desc");
                                $data_paket = mysqli_fetch_array($qry_paket);
                                $qry_user = mysqli_query($conn, "select * from user order by id_user desc");
                                $data_user = mysqli_fetch_array($qry_user);
                                $no = 0;
                                while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
                                    $no++;
                                    $qry_member_kembali = mysqli_query($conn, "select * from transaksi inner join member on member.id = transaksi.id where transaksi.id_transaksi = '" . $data_transaksi['id_transaksi'] . "'");
                                    ...
                                    $qry_cek_kembali = mysqli_query($conn, "select * from transaksi where id_transaksi = '" . $data_transaksi['id_transaksi'] . "'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($data_transaksi['status'] == "baru") {
                                            ?> <a href="ubah_proses.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?> " class="btn btn-warning">proses</a>
                                                <a href="ubah_selesai.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-success">selesai</a>
                                                <a href="ubah_diambil.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-primary">diambil</a>
                                            <?php
