...
<body id="page-top">
    ...
    while($data_paket=mysqli_fetch_array($qry_get_paket)){
...
echo '<option value="'.$data_paket['id_paket'].'" '.$selek.'></option>';   
	...
	<a href="tampil_paket.php"> <input type="submit" name="simpan" value="Ubah Member" class="btn btn-success" style="margin-left: 10px;"></a>
